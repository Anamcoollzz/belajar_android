...
public class DirectionFinderHelper {
    ...
    private static final String GOOGLE_DIRECTION_API_KEY = "AIzaSyBsVXugKZkrB2tkAgGAlkNk6lI0_oNVVic";  // replace with your google direction api
    private DirectionFinderListener listener;
    private String origin;
    private String destination;

    public DirectionFinderHelper(DirectionFinderListener listener, String origin, String destination) {
